...
import imag1 from "../../../assets/prozessengineering_opt2_final-74198fca.webp";
...
const HeroEng = () => {
  const advantages = [
    ...
    "Years of experience in plant engineering",
  ];
  return (
    <>
      <div className="relative w-full h-[670px] lg:h-[1000px] overflow-hidden">
        ...
        {/*Text Overlay */}
        <div className="relative wrap inset-0 w-full 2xl:max-w-[1400px] 2xl:mx-auto lg:mx-auto lg:px-5 2xl:px-5 px-3 z-10 lg:pt-[300px] 2xl:pt-[300px] pt-[110px] text-right overflow-hidden">
          <div className="inline-block text-left max-w-[450px]">
            ...
            <p className="text-[18px] font-thin lg:text-[31px] text-[#0F3354] lg:leading-[37px]">
                Dendrites implements {" "}
              <strong className="font-bold lg:text-[#80acd3] 2xl:text-[#80acd3] text-[#0F3354]">
                highly complex projects in the shortest possible time
              </strong>
            </p>

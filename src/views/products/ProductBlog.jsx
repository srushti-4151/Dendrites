  ...
  return (
    <>
      <div className="bg-[#00223E]">
        <div className="lg:max-w-[1410px] lg:w-full 2xl:w-full 2xl:max-w-[1410px] lg:py-[100px] 2xl:py-[100px] py-[50px] w-full mx-0 overflow-hidden lg:mx-auto 2xl:mx-auto max-w-full h-full lg:px-5 2xl:px-0 px-4 bg-[#00223E]">

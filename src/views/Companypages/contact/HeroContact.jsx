...
const HeroContact = () => {
  ...
  return (
    <>
      <div className="relative w-full h-[790px] lg:h-[1100px] overflow-hidden">
        {/* Background Image */}
        ...
        <div className="relative wrap inset-0 w-full 2xl:max-w-[1400px] 2xl:mx-auto lg:mx-auto lg:px-5 2xl:px-5 px-3 z-10 lg:pt-[340px] 2xl:pt-[340px] pt-[110px] text-right overflow-hidden">
          <div className="inline-block text-left max-w-[450px]">
            ...
            <p className="text-[18px] font-thin lg:text-[31px] text-[#0F3354] lg:leading-[37px]">
              ...
              <br />
              Contact persons in Sales und Business Development.
            </p>
        ...
        <div className="relative lg:mx-auto 2xl:mx-auto py-[15x] lg:mt-[150px] 2xl:mt-[150px] mt-[50px] mb-[30px] lg:mb-0 2xl:mb-0 lg:w-[1380px] 2xl:w-[1380px] w-full z-20 px-3">
              ...
              >
                <span
                  className={`absolute top-0 transform -translate-x-1/2 -translate-y-1/2 font-bitter font-bold text-[84px] leading-[1.16666667] text-[rgba(128,172,211,0.5)] z-1 ${
                    index === 0 ? "left-[0px]" : "left-[23px]"
                  }`}
                >
                  {index + 1}
                </span>
                <div className="relative block m-0 font-bold lg:text-[18px] 2xl:text-[18px] leading-[1.16666667] text-[#00223e] z-2">
                  {advantage}
                </div>
              </li>
            ))}
          ...
          <ul className="2xl:hidden lg:hidden block">
            {advantages.map((advantage, index) => (
              ...
              >
                ...
                <div className="relative block m-0 text-base leading-[1.16666667] text-[#00223e] z-2">
                  {advantage}
                </div>
              </li>
            ))}

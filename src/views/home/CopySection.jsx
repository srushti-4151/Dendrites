...
const CopySection = () => {
  return (
    <div className="border-t border-[#80acd3] bg-[#00223e]">
        ...
        <div className="flex justify-between items-center flex-wrap py-4 px-6 ">
          ...
          <div className="flex flex-wrap items-center justify-center mx-auto gap-3 mb-4 sm:mb-0 lg:pr-24">
            <div className="group border border-[#80acd3] p-2 rounded-full hover:bg-[#80acd3] cursor-pointer">
              <FaLinkedinIn className="text-[#80acd3] group-hover:text-white text-2xl transition duration-300" />
            </div>
            <div className="group border border-[#80acd3] p-1 rounded-full hover:bg-[#80acd3] cursor-pointer">
              <IoLogoFacebook className="text-[#80acd3] group-hover:text-white text-3xl  transition duration-300" />
            </div>
            <div className="group border border-[#80acd3] p-2 rounded-full hover:bg-[#80acd3] cursor-pointer">
              <FaYoutube className="text-[#80acd3] group-hover:text-white text-2xl  transition duration-300" />
            </div>
            <div className="group border border-[#80acd3] p-2 rounded-full hover:bg-[#80acd3] cursor-pointer">
              <IoLogoVimeo className="text-[#80acd3] group-hover:text-white text-2xl  transition duration-300" />
            </div>
            <div className="group border border-[#80acd3] p-2 rounded-full hover:bg-[#80acd3] cursor-pointer">
              <RiInstagramFill className="text-[#80acd3] group-hover:text-white text-2xl transition duration-300" />
            </div>
          </div>

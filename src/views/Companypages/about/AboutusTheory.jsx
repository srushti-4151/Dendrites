...
const AboutusTheory = () => {
  return (
    <>
      <div className="bg-[#022E55] w-full py-[73px]">
        <div className="max-w-[1016px] w-full mx-auto text-white">
          <h2 className="text-[57px] font-bold leading-[1.157] uppercase text-center text-shadow-glow mb-5">
            About Us
          </h2>
          <div className="font-light text-[30px] leading-[1.333] text-center">
        ...
        <div className="max-w-[888px] w-full mx-auto mt-[60px] text-center text-white font-bold text-[18px] leading-[1.388]">
